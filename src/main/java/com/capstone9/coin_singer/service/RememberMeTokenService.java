...
import com.capstone9.coin_singer.domain.member.RememberMeToken;
import com.capstone9.coin_singer.domain.member.RememberMeTokenRepository;
...
public class RememberMeTokenService implements PersistentTokenRepository {
    ...
    public void removeUserTokens(String username) {
        ...
        if(tokens.size() > 0){
            this.rememberMeTokenRepository.delete(tokens.get(0));
        }
